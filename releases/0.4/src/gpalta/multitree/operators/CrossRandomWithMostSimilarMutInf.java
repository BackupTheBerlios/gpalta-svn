/*
 * CrossRandomWithMostSimilarMutInf.java
 *
...
public class CrossRandomWithMostSimilarMutInf extends LowLevelMultiTreeOperator
{
    public CrossRandomWithMostSimilarMutInf(TreeOperator op)
    {
        super(op);
    }
